...
CREATE TABLE COMMENTS (ID INT AUTO_INCREMENT PRIMARY KEY, USERNAME VARCHAR(100) NOT NULL, POST_DATETIME DATETIME DEFAULT NOW() ON UPDATE NOW() NOT NULL, CONTENT TEXT NOT NULL, BLOG_ID INT FOREIGN KEY REFERENCES BLOGS(ID) ON DELETE CASCADE);